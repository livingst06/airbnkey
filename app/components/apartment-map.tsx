...
export function ApartmentMap({
  ...
  const createMarkerForApartment = useCallback(
    ...
    markerLabel.className =
      "max-w-[156px] truncate text-[12px] font-semibold leading-none"
    markerLabel.textContent = apartment.title
    ...
    popupBody.append(popupTitle, popupMeta)
    popupContent.append(popupImage, popupBody)
